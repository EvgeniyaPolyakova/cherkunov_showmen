...
const Privacy = () => {
	...
	return (
		<>
			<Head>
				<title>Ведущий Юрий Черкунов - Политика конфиденциальности</title>
			</Head>
			<div>
				<Header />
				<Button
				...
				<div className={cn(utils.container, s.content)}>
					<h1 className={s.title}>Политика в отношении обработки персональных данных</h1>
					<h2 className={s.subTitle}>1. Общие положения</h2>
					<p className={s.text}>
						...
						предпринимаемые Черкуновым Юрием Владимировичем (далее — Оператор).
					</p>
					<ul className={s.list}>
						<li>
						...
						<li>
							...
							ко всей информации, которую Оператор может получить о посетителях веб-сайта https://cherkunov37.ru//.
						</li>
					</ul>
					<h2 className={s.subTitle}> 2. Основные понятия, используемые в Политике</h2>
					<ul className={s.list}>
						<li>
						...
						<li>
							...
							данных, обеспечивающих их доступность в сети интернет по сетевому адресу https://cherkunov37.ru//.
						</li>
						...
						<li>
							...
							определяемому Пользователю веб-сайта https://cherkunov37.ru//.
						</li>
						...
						<li>2.10. Пользователь — любой посетитель веб-сайта https://cherkunov37.ru//.</li>
					...
					<h2 className={s.subTitle}>3. Основные права и обязанности Оператора</h2>
					<ul className={s.list}>
						<li>
						...
						<li>
							...
							неограниченный доступ к настоящей Политике в отношении обработки персональных данных; — принимать
							правовые, организационные и технические меры для защиты персональных данных от неправомерного или
					...
					<h2 className={s.subTitle}>4. Основные права и обязанности субъектов персональных данных</h2>
					<ul className={s.list}>
						<li>
							...
							а также принимать предусмотренные законом меры по защите своих прав; — выдвигать условие предварительного
							согласия при обработке персональных данных в целях продвижения на рынке товаров, работ и услуг; — на отзыв
							согласия на обработку персональных данных, а также, на направление требования о прекращении обработки
							персональных данных; — обжаловать в уполномоченный орган по защите прав субъектов персональных данных или
							в судебном порядке неправомерные действия или бездействие Оператора при обработке его персональных данных;
					...
					<h2 className={s.subTitle}>5. Принципы обработки персональных данных</h2>
					<ul className={s.list}>
					...
					<h2 className={s.subTitle}>6. Цели обработки персональных данных</h2>
					<p className={s.text}>Цель обработки: заключение, исполнение и прекращение гражданско-правовых договоров</p>
					<p className={s.text}>Персональные данные: номера телефонов имя</p>
					<p className={s.text}>
					...
					<h2 className={s.subTitle}>7. Условия обработки персональных данных</h2>
					<ul className={s.list}>
						<li>
					...
					<ul className={s.list}>
						...
						<li>
							...
							vvs.v.05@mail.ru с пометкой «Актуализация персональных данных».
						</li>
						<li>
							...
							Оператору уведомление посредством электронной почты на электронный адрес Оператора vvs.v.05@mail.ru с
					...
					<h2 className={s.subTitle}>10. Трансграничная передача персональных данных</h2>
					<ul className={s.list}>
						<li>
					...
					<h2 className={s.subTitle}>11. Конфиденциальность персональных данных</h2>
					<p className={s.text}>
					...
					<h2 className={s.subTitle}>12. Заключительные положения</h2>
					<ul className={s.list}>
						<li>
							12.1. Пользователь может получить любые разъяснения по интересующим вопросам, касающимся обработки его
							персональных данных, обратившись к Оператору с помощью электронной почты vvs.v.05@mail.ru.
						</li>
