		...
		<div>
			...
			<div className={cn(utils.container, s.content)}>
				...
				<p className={s.text}>
					...
					Черкуновым Юрием Владимировичем (далее — Оператор).
				</p>
				<ul className={s.list}>
					<li>
					...
					<li>
						...
						ко всей информации, которую Оператор может получить о посетителях веб-сайта https://thismywebsite.com.
					</li>
				</ul>
				...
				<ul className={s.list}>
					...
					<li>
						...
						обеспечивающих их доступность в сети интернет по сетевому адресу https://thismywebsite.com.
					</li>
					...
					<li>
						...
						определяемому Пользователю веб-сайта https://thismywebsite.com.
					</li>
